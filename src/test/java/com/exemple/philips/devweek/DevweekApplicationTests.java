package com.exemple.philips.devweek;
...
class DevweekApplicationTests {
    ...
    public void addNewRegiaoTest() throws Exception {
        ...
        mockMvc.perform(post(URL+"/add").contentType(MediaType.APPLICATION_JSON).content(asJsonString(newRegiao))).andExpect(status().isOk());
    }
    ...
    public void deleteByIdRegiaoTest() throws Exception {
        ...
        mockMvc.perform(delete(URL+"/delete/{id}", "6").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
